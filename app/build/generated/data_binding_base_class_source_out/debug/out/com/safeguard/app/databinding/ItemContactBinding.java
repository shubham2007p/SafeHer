...
public final class ItemContactBinding implements ViewBinding {
  ...
  private ItemContactBinding(@NonNull CardView rootView, @NonNull ImageView btnDelete,
  ...
  public static ItemContactBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemContactBinding((CardView) rootView, btnDelete, tvName, tvPhone);
    }
